...
/* ******************************************************************************************* */
   ...
   /** Converts dates from numerical format yyyy-mm-dd to wordy descriptions.
    * lang indicates the language. So far, only spanish is implemented. */
   static string GetLongWordsDate(const string &yyyymmdd,char lang='s');
protected:
   /* ************************************************************************** */
};
/* ************************************************************************** */
