/*
   ...
   README file.
*/
/* optflagsbase.h (OptionFlagsBase)
   
   This class is the abstract class for parsing and handling command line
   ...
   WWW:  http://www.gnu.org/copyleft/gpl.html
	...
	----------------------
*/
#ifndef _OPTFLAGSBASE_H_
#define _OPTFLAGSBASE_H_
#include <string>
using std::string;
/* ************************************************************************** */
...
/* ************************************************************************** */
public:
   enum class OptFlgsExitCodes {
      OFEC_CONTINUE, OFEC_EXITNOERR, OFEC_EXITERR
   };
   OptionFlagsBase() {}
   virtual ~OptionFlagsBase() {}
   virtual void PrintErrorMessage(char** &argv,char lab) = 0;
   virtual void PrintHelpMenu(int argc, char** &argv) = 0;//self-described
   virtual void ProcessDoubleDashOptions(int argc,char** &argv,int &pos) = 0;
   virtual int CountInputFiles(const int startpos) {return 1;}
/* ************************************************************************** */
   unsigned short int infname=0,outfname=0;
   OptionFlagsBase::OptFlgsExitCodes exitCode() {return exitcode;}
/* ************************************************************************** */
protected:
   OptionFlagsBase::OptFlgsExitCodes exitcode=OptFlgsExitCodes::OFEC_CONTINUE;
